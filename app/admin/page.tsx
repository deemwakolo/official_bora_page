      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <section className="bg-zinc-900 p-6 rounded-lg border border-zinc-800">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <input type="text" name="title" placeholder="Track Title" required className="w-full bg-black border border-zinc-700 p-3 rounded" />
            <input type="text" name="artist" placeholder="Artist Name" required className="w-full bg-black border border-zinc-700 p-3 rounded" />
            
            <div className="grid grid-cols-2 gap-4">
              <input type="number" name="yt_views" placeholder="YT Views" className="bg-black border border-zinc-700 p-3 rounded" />
              <input type="number" name="sp_plays" placeholder="Spotify Plays" className="bg-black border border-zinc-700 p-3 rounded" />
            </div>

            <div className="border-2 border-dashed border-zinc-700 p-8 text-center rounded hover:border-[#b91c1c] transition-colors">
            ...
            <button disabled={loading} className="w-full bg-[#b91c1c] p-4 font-bold uppercase tracking-widest hover:bg-red-700 disabled:opacity-50">
        ...
        <section className="bg-zinc-900 p-6 rounded-lg border border-zinc-800">
          ...
          <textarea placeholder="Write update or paste Instagram link..." className="w-full h-32 bg-black border border-zinc-700 p-3 rounded mb-4" />
