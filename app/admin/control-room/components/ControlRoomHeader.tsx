...
// NORMAL HEADER YA CONTROL ROOM.
// Frontend masthead (bora-hdr-surface + sidebar) haikopiwwi hapa —
// header rahisi ndio inatumika kama ulivyoombwa.
