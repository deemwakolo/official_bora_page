...
// COPY YA frontend Navbar — section ya UPDATES imeondolewa kama
// ulivyoomba, kuna nne tu: charts, trending, vote, profile.
...
interface ControlRoomNavbarProps {
  activeSection: ControlRoomSection;
  onSectionChange: (section: ControlRoomSection) => void;
}

const sections = [
  {
    id: 'charts' as ControlRoomSection,
    label: 'Charts',
    ariaLabel: 'Charts',
    Icon: BarChart3,
  },
  {
    id: 'trending' as ControlRoomSection,
    label: 'Trending',
    ariaLabel: 'Trending',
    Icon: TrendingUp,
  },
  {
    id: 'vote' as ControlRoomSection,
    label: 'Vote',
    ariaLabel: 'Vote',
    Icon: Crown,
  },
  {
    id: 'profile' as ControlRoomSection,
    label: 'Profile',
    ariaLabel: 'Profile',
    Icon: User,
  },
...
export default function ControlRoomNavbar({
  activeSection,
  onSectionChange,
}: ControlRoomNavbarProps) {
  const handlePress = (id: ControlRoomSection) => {
    onSectionChange(id);
  };
  ...
  return (
    ...
    >
      ...
      >
        {/* DESTINATIONS (UPDATES IMEONDOLEWA) */}
