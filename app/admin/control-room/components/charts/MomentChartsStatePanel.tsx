...
interface MomentChartsStatePanelProps {
  title: string;
...
/*
 * BORA MOMENT CHARTS STATE PANEL
 *
 * Same honest-state treatment as OperationsStatePanel (loading / error /
 * empty): centered bordered surface, Cinzel title, no invented data.
 * Local copy (no Operations import) so Control Room Charts stays
 * independent of the Operations room.
 */
export default function MomentChartsStatePanel({
  title,
  lines,
  tone = 'idle',
  onRetry,
}: MomentChartsStatePanelProps) {
  return (
    <div
