...
interface OperationsStatePanelProps {
  title: string;
...
/*
 * BORA OPERATIONS STATE PANEL
 *
 * Honest state pekee: loading, error au workspace ambayo backend
 * yake haijaunganishwa bado. HAKUNA data ya kubuni (fake counts,
 * fake metrics, fake artists) ya kujaza screen.
 */
export default function OperationsStatePanel({
  title,
  lines,
  tone = 'idle',
  onRetry,
}: OperationsStatePanelProps) {
  return (
    <div
