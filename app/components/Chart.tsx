            ...
            >
              <div className="flex items-center w-full md:w-auto mb-3 md:mb-0">
                <div className="relative flex-shrink-0 mr-4 md:mr-8">
                  ...
                  >
                    {item.cover_url ? (
                      <img src={item.cover_url} alt={item.title} className="w-full h-full object-cover grayscale transition-all group-hover:grayscale-0" />
                    ) : (
                      <div className="w-full h-full flex items-center justify-center text-[10px] text-white/20 uppercase">No Art</div>
                    )}
                  </div>
              ...
              <div className="flex items-center justify-between w-full md:w-auto md:ml-auto gap-4 md:gap-10">
                ...
                <div className="flex gap-2">
                  <button 
                    ...
                    className={`flex items-center justify-center rounded-full border transition-all active:scale-90 ${isTop3 ? 'w-10 h-10 md:w-14 md:h-14 bg-[#b91c1c] border-[#D4AF37]' : 'w-8 h-8 md:w-10 md:h-10 border-white/10 hover:border-[#D4AF37]'}`}
                  >
