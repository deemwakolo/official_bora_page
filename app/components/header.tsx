...
export default function Header() {
  return (
    <header className="relative w-full bg-[#050505] overflow-hidden border-b border-[#D4AF37]/20">
      ...
      {/* 1. LAYER 1: KITENGE GRADIENT 
          Maintaining the Kitenge texture with the Bongo Flava red glow.
      */}
      <div 
      ...
      {/* 2. MAIN CONTENT (Forced Centering) */}
      <div className="max-w-7xl mx-auto px-4 py-4 md:py-6 flex flex-col items-center justify-center relative z-10 font-cinzel">
        
        {/* THE TYPOGRAPHY (Perfectly Centered) */}
        <div className="flex flex-col items-center text-center mb-2 md:mb-4">
          <h1 className="text-4xl md:text-7xl font-black tracking-[0.25em] text-white leading-none drop-shadow-[0_4px_8px_rgba(0,0,0,1)] uppercase">
            BORA <span className="text-[#D4AF37]">CHARTS</span>
          </h1>
          
          <div className="flex items-center justify-center gap-3 mt-1">
            <div className="h-[1px] w-10 md:w-16 bg-[#D4AF37]/60" />
            <p className="text-[10px] md:text-[12px] tracking-[0.5em] text-[#C0C0C0] uppercase font-bold">
              The Gold Standard
            </p>
            <div className="h-[1px] w-10 md:w-16 bg-[#D4AF37]/60" />
          </div>
        ...
        {/* 3. NAVIGATION (Forced Centering) */}
        <nav className="w-full max-w-xl border-t border-white/10 pt-3">
          <ul className="flex items-center justify-center gap-x-10 md:gap-x-16 w-full">
